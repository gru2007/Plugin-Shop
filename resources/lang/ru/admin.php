...
return [
    ...
    'settings' => [
        ...
        'recent_payments' => 'Количество последних платежей в боковой панели (0 - отключить)',
        'display_amount' => 'Показывать сумму в недавних платежах и лучшем покупателе',
        'guest_checkout' => 'Разрешить покупки без регистрации',
        'top_customer' => 'Показывать лучшего покупателя месяца',
